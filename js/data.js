...
const GIF_MAPPING = {
  ...
  'machine-chest-press': 'machine_inner_chest_press.gif',
  'cable-crossover': 'cable_crossover.gif',
  'butterfly-machine': null,
  ...
  'prensa-de-piernas-45-grados': null,
  'prensa-de-piernas-horizontal': null,
  'extensiones-de-cuadriceps-en-maquina': 'leg_extension.gif',
  'step-ups-con-mancuernas': 'dumbbell_step_up.gif',
  'lunges-caminando-con-mancuernas': 'walking_lunge.gif',
  'lunges-estaticos-con-mancuernas': 'stationary_lunge.gif',
  'hack-squats-en-maquina': 'hack_squat.gif',
  'curl-de-piernas-hamstrings-en-maquina': 'leg_curl.gif',
  'curl-de-piernas-acostado-con-mancuerna': 'dumbbell_leg_curl.gif',
  'curl-de-piernas-de-pie-con-mancuerna': 'standing_leg_curl.gif',
  'peso-muerto-rumano-con-barra': 'romanian_deadlift.gif',
  'peso-muerto-con-mancuernas': 'dumbbell_deadlift.gif',
  'buenos-dias-con-barra': 'good_morning.gif',
  'hip-thrust-glute-bridge-con-barra': 'barbell_hip_thrust.gif',
  'hip-thrust-con-mancuerna': 'single_leg_hip_thrust.gif',
  'peso-muerto-con-barra': 'barbell_deadlift.gif',
  'peso-muerto-sum-cero-trap-bar': 'trap_bar_deadlift.gif',
  ...
  'shrug-con-barra': 'barbell_shrug.gif',
  'shrug-con-mancuernas': 'dumbbell_shrug.gif',
  'face-pull': 'face_pull.gif',
  'behind-the-neck-press': 'behind_the_neck_press.gif',
  'landmine-press': 'landmine_press.gif',
  'pike-push-up': 'pike_push_up.gif',
  'handstand-push-up': 'handstand_push_up.gif',
  'lateral-raise-machine': null,
  'rear-delt-machine': null,
  ...
  'ab-wheel-rollout': 'ab_wheel_rollout.gif',
  'dragon-flag': 'dragon_flag.gif',
  'l-sit': 'l_sit.gif',
  'hollow-body-hold': 'hollow_body_hold.gif',
  'v-up': 'v_up.gif',
  'jackknife-sit-up': 'jackknife_sit_up.gif',
  'toes-to-bar': 'toes_to_bar.gif',
  'windshield-wipers': 'windshield_wipers.gif',
  'pallof-press': 'pallof_press.gif',
  'wood-chopper': 'wood_chopper.gif',
  'side-plank': 'side_plank.gif',
  'bird-dog': 'bird_dog.gif',
  'dead-bug': 'dead_bug.gif',
  'superman': 'superman.gif',
  'reverse-snow-angel': 'reverse_snow_angel.gif',
  'copenhagen-plank': 'copenhagen_plank.gif',
  'single-leg-glute-bridge': 'single_leg_glute_bridge.gif',
  'frog-pump': 'frog_pump.gif',
  'donkey-kick': 'donkey_kick.gif',
  'fire-hydrant': 'fire_hydrant.gif',
  'clamshell': 'clamshell.gif',
  'standing-calf-raise': 'standing_calf_raise.gif',
